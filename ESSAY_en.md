...
It started as an experiment in plain [Russian](re-think/prompts/re-think_v1_ru.md) (full and [compact](re-think/prompts/re-think_v1_ru_compact.md) versions), then [English](re-think/prompts/re-think_v1_en.md) (full and [compact](re-think/prompts/re-think_v1_en_compact.md) versions — the English compact came in at around 1,300 tokens).
...
📂 **[View all four case studies → examples_en.md](re-think/examples_en.md)**  
📂 **[Русские примеры → examples_ru.md](re-think/examples_ru.md)** *(HR-кейс с HARD STOP)*
...
[English](re-think/README.md) | [Русская версия](re-think/README_ru.md) | [中文说明](re-think/README_zh.md)
